#!/usr/bin/env python3
# Auto-generated by TreeShellLibraryFactory (FIXED)
...
class GnosysConfigLoader(SystemConfigLoader):
...
class GnosysTreeShell(TreeShell):
    """Gnosys TreeShell - MCP Router interface."""
    def __init__(self, user_config_path: str = None):
        config_loader = GnosysConfigLoader(config_types=["base", "base_zone_config", "base_shortcuts"])
